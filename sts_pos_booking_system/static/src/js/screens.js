...
odoo.define('sts_pos_booking_system.screens', function (require) {
    ...
    models.load_models([{
        model: 'booking.order',
        fields: ['name', 'state', 'time_slot_id', 'customer', 'end_time', 'reschedule_use', 'company_id', 'booking_source', 'plan_price', 'time_slot_ids', 'booking_product_id', 'plan_id', 'quantity', 'booking_date', 'id', 'table_id'],
        domain: [
