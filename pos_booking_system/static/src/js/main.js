    ...
    odoo.define('pos_booking_managment.pos_booking_managment', function (require) {
        "use strict";
        ...
        //     }),
            ...
            book_reservation () {
                ...
                rpc.query({
                        ...
                        model: 'booking.order',
                        args: [self.selected_timeslots, product_id, input_date, partner_id, self.env.pos.config.company_id[0]]
                    }).then(function (res) {
                ...
                $('.popup').on('change', '.booking_dates', function (e) {
                    if(!self.is_changed){
                        ...
                        rpc.query({
                                ...
                                'model': 'pos.order',
                                'args': [self.props.product_tmpl_id, input_date]
                            })
                            .then(function (result) {
	...
	Registries.Component.extend(ProductScreen, PosProductScreen);
        ...
        models.PosModel = models.PosModel.extend({
            ...
            is_booking_order: function () {
                ...
                _.each(self.get_order().get_orderlines(), function (line) {
